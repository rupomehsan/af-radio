...
{{--                            <button type="submit" class="" onclick="deleteItem('{{ URL::to('/admin/notification/' . $data->id) }}')" title="Delete"><iconify-icon icon="bi:send-x-fill"></iconify-icon> Resend</button>--}}
                            <button type="submit" class="" onclick="deleteItem('{{ URL::to('/admin/notification/' . $data->id) }}')" title="Delete"> <iconify-icon icon="ant-design:delete-filled"
