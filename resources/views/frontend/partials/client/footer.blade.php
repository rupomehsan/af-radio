                ...
                ?>
                 ...
                 <div class="widget">
                    <a href="{{ url('/frontend') }}">
                        ...
                        @if (!empty($logo->logo))
                            <img src="{{ URL::to('/') }}/uploads/{{ $logo->logo }}" alt="No Logo" height="200" width="200" />
                        @else
                            <img src="{{ URL::to('/') }}/uploads/logo.jpg" alt="" height="200" width="200" />
                        @endif
                    </a>
                     {{-- <img src="{{ asset('assets/img/xflix-logo.png') }}" alt="about" height="80" width="80" /> --}}
         ...
         <div class="container">
             <div class="row">
                 <div class="col-lg-6 text-center text-lg-left">
                    &copy; {{date('Y')}} XFlix | Powerd By
                    <a target="_blank" href="http://www.projectx.com.bd/">Project X</a>
 ...
 <script>
     ...
     $(document).on("click", "#registrationStore", function(e) {
         ...
         $.ajax({
             url: "{{ URL::to('frontend/user/registration') }}",
             type: 'POST',
             dataType: "json",
             processData: false,
             contentType: false,
     ...
     ! function(e, n, t) {
         ...
         function o() {
             var e, n, t, o, s, i, f;
             for (var a in y) {
                 if (e = [], n = y[a], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n
                         .options.aliases.length))
                     for (t = 0; t < n.options.aliases.length; t++) e.push(n.options.aliases[t].toLowerCase());
                 for (o = r(n.fn, "function") ? n.fn() : n.fn, s = 0; s < e.length; s++) i = e[s], f = i.split("."),
                     1 === f.length ? Modernizr[f[0]] = o : (!Modernizr[f[0]] || Modernizr[f[0]] instanceof Boolean || (
                         Modernizr[f[0]] = new Boolean(Modernizr[f[0]])), Modernizr[f[0]][f[1]] = o), C.push((o ? "" :
                         "no-") + f.join("-"))
             }
         }
         ...
         function f(e, t, r, o) {
             ...
             return f = s("style"), f.type = "text/css", f.id = "s" + p, (c.fake ? c : d).appendChild(f), c.appendChild(
                     d), f.styleSheet ? f.styleSheet.cssText = e : f.appendChild(n.createTextNode(e)), d.id = p, c
                 .fake && (c.style.background = "", c.style.overflow = "hidden", l = S.style.overflow, S.style.overflow =
                     "hidden", S.appendChild(c)), a = t(d, e), c.fake ? (c.parentNode.removeChild(c), S.style.overflow =
                     l, S.offsetHeight) : d.parentNode.removeChild(d), !!a
         }
         ...
         function p(n, r) {
             ...
             if ("CSSSupportsRule" in e) {
                 ...
                 return s = s.join(" or "), f("@supports (" + s + ") { #modernizr { position: absolute; } }", function(
                     e) {
         ...
         function d(e, n, o, i) {
             ...
             for (var d, c, m, v, h, y = ["modernizr", "tspan"]; !k.style;) d = !0, k.modElem = s(y.shift()), k.style = k
                 .modElem.style;
         ...
         function v(e, n, t, o, s) {
             ...
             return r(n, "string") || r(n, "undefined") ? d(f, n, o, s) : (f = (e + " " + T.join(i + " ") + i).split(
                 " "), m(f, n, t))
         }
         ...
         Modernizr._q.unshift(function() {
             ...
             if (e && (!n || "webkitPerspective" in S.style)) {
                 var t;
                 Modernizr.supports ? t = "@supports (perspective: 1px)" : (t = "@media (transform-3d)", n && (
                         t += ",(-webkit-transform-3d)")), t +=
                     "{#modernizr{left:9px;position:absolute;height:5px;margin:0;padding:0;border:0}}", b(t,
                         function(n) {
     ...
     (function($) {
         ...
         $.carrousel.prototype = {
             ...
             _setItems: function() {
                 ...
                 this.$leftItm = (this.current === 0) ? this.$items.eq(this.itemsCount - 1) : this.$items.eq(
                     this.current - 1);
                 this.$rightItm = (this.current === this.itemsCount - 1) ? this.$items.eq(0) : this.$items
                     .eq(this.current + 1);
                 this.$nextItm = (this.$rightItm.index() === this.itemsCount - 1) ? this.$items.eq(0) : this
                     .$rightItm.next();
                 this.$prevItm = (this.$leftItm.index() === 0) ? this.$items.eq(this.itemsCount - 1) : this
                     .$leftItm.prev();
             },
             ...
             _getCoordinates: function(position) {
                 if (this.support3d) {
                     switch (position) {
                         ...
                         case 'left':
                             return {
                                 '-webkit-transform': 'translateX(-' + this.CSSX +
                                     'px) translateZ(-300px) rotateY(25deg)',
                                     '-moz-transform': 'translateX(-' + this.CSSX +
                                     'px) translateZ(-300px) rotateY(25deg)',
                                     '-o-transform': 'translateX(-' + this.CSSX +
                                     'px) translateZ(-300px) rotateY(25deg)',
                                     '-ms-transform': 'translateX(-' + this.CSSX +
                                     'px) translateZ(-300px) rotateY(25deg)',
                         ...
                         case 'right':
                             return {
                                 '-webkit-transform':
                                 'translateX(410.1px) translateZ(-300px) rotateY(-80deg)',
                                 '-moz-transform': 'translateX(410.1px) translateZ(-300px) rotateY(-80deg)',
                                 '-o-transform': 'translateX(410.1px) translateZ(-300px) rotateY(-80deg)',
                                 '-ms-transform': 'translateX(410.1px) translateZ(-300px) rotateY(-80deg)',
                                 'transform': 'translateX(410.1px) translateZ(-300px) rotateY(-80deg)',
                                 'opacity': 1,
                                 'visibility': 'visible'
                             };
                             break;
                 ...
                 if (!this.isAnim) {
                     ...
                     switch (dir) {
                         case 'next':
                             ...
                             var nextEle = (this.$nextItm.index() === this.itemsCount - 1) ? this.$items.eq(
                                 0) : this.$nextItm.next();
                         ...
                         case 'prev':
                             ...
                             var prevEle = (this.$prevItm.index() === 0) ? this.$items.eq(this.itemsCount -
                                 1) : this.$prevItm.prev();
