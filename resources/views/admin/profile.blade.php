...
@section('data_count')
    ...
    @endif
    {{-- Start::Content Body --}}
    <form id="adminCreateForm" method="POST" enctype="multipart/form-data" action="{{ URL::to('admin/profile/' . $target->id . '/update') }}">
        @csrf
                ...
                <div class="col-md-6">
                    <div class="file-upload-edit">
                        ...
                        <div class="file-upload-content-edit">
                            <img class="file-upload-image-edit" src="{{ $target->image ?? asset('assets/img/dummy.jpg') }}"
                                 alt="your image" />
