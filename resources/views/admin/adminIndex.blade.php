                    ...
                    @foreach ($target as $data)
                        <tr>
                            ...
                            <td class="text-center table-image">
                                @if (!empty($data->image))
                                    <img src="{{ $data->image }}"
                                        alt="{{ $data->name }}" title="{{ $data->name }}" height="30" />
                                @else
                                    <img class="border" src="{{ asset('assets/img/dummy.jpg')}}" alt="" height="20" />
                                @endif
                            </td>
                            ...
                            <td class="table-actions text-center">
                                    ...
                                    <button type="submit" class="" onclick="deleteItem('admin/{{$data->id}}')" title="Delete">DELETE</button>
                            </td>
                        </tr>
                    @endforeach
                @endif
