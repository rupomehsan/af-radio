                ...
                <div class="col-sm-7 col-md-6 col-lg-7 col-xl-6">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-sm-3 col-md-3 ">
                            <h6 class="font-weight-bold">Playlist</h6>
                        </div>
                ...
                success: function (res) {
                    if (res.status === "success") {
                        res.data.forEach((item) => {
                            if (item.service_name === "playlist" && item.status === "active") {
...
<div  id="multipleAudioSec">
       <div class="d-flex justify-content-between align-items-center">
        ...
        function getSearchData(data) {
            $.ajax({
                method: "get",
                url: rootUrl + "get_playlist_search_data",
                dataType: "json",
                data: {"value": data},
                success: function (response) {
                    if (response.status === 'success') {
        ...
        $(document).on("click", ".editBtn", function () {
            ...
            let url = rootUrl + "playlist/" + contestId
            getContest(url)
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            ...
                            Object.entries(response.data).forEach((item) => {
                                ...
                                if (item[0] === "image") {
                                    if (item[1] === null) {
                                        $('.file-upload-image-edit').attr('src', "<?php echo e(asset('assets/img/dummy.jpg')); ?>")
                                        $('.file-upload-image').attr('src', "<?php echo e(asset('assets/img/dummy.jpg')); ?>")
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/af_radio/resources/views/playlist/index.blade.php ENDPATH**/ ?>