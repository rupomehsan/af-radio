                    ...
                    <?php $__currentLoopData = $target; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center table-image">
                                <?php if(!empty($data->image)): ?>
                                    <img src="<?php echo e($data->image); ?>"
                                        alt="<?php echo e($data->name); ?>" title="<?php echo e($data->name); ?>" height="30" />
                                <?php else: ?>
                                    <img class="border" src="<?php echo e(asset('assets/img/dummy.jpg')); ?>" alt="" height="20" />
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="table-actions text-center">
                                    ...
                                    <button type="submit" class="" onclick="deleteItem('admin/<?php echo e($data->id); ?>')" title="Delete">DELETE</button>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/af_radio/resources/views/admin/adminIndex.blade.php ENDPATH**/ ?>