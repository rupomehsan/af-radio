        ...
        <div class="row margin-top-40 content-details px-3">
            <table class="table border ">
                ...
                <tr>
                    ...
                    <th scope="col" style="width: 20%" class="text-center">Shoutouts</th>
...
<?php $__env->startPush('custom-js'); ?>
    <script type="text/javascript">
                ...
                success: function (res) {
                    if (res.status === "success") {
                        res.data.forEach((item) => {
                            if (item.service_name === "shoutouts" && item.status === "active") {
        ...
        $(document).on("click", ".responseBtn", function () {
            ...
            let url = rootUrl + "shoutouts/" + dataId
            $.ajax({
                method: "patch",
                url: url,
                dataType: "json",
        ...
        function getSearchData(data) {
            ...
            $.ajax({
                method: "get",
                url: rootUrl + "get_shoutouts_search_data",
                dataType: "json",
                data: {"value": data},
                success: function (response) {
                    if (response.status === 'success') {
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/af_radio/resources/views/shoutouts/index.blade.php ENDPATH**/ ?>