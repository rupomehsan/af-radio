<?php $__env->startSection('data_count'); ?>
    ...
    <form id="settingsForm" method="POST" enctype="multipart/form-data"
          action="<?php echo e(URL::to('admin/basic-settings/create')); ?>">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6 margin-top-10">
                <div class="form-group">
                    ...
                    <div style="position: relative" class="mt-1">
                        <img src="<?php echo e(asset('assets/img/dummy.jpg')); ?>" height="100" width="100"
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/af_radio/resources/views/settings/index.blade.php ENDPATH**/ ?>