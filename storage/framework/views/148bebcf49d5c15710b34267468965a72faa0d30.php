                ...
                <div class="form-group">
                    ...
                    <div style='height: 0px;width: 0px; overflow:hidden;'>
                        <input class="file-uploader " id="upfile" type="file" value="upload" onchange="sub(this)"/>
                           <input type="hidden" name="banner_image" class="banner_image" value="<?php echo e($target->banner_image); ?>"/>
                    </div>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/afradio.ccninfotech.com/resources/views/settings/basicSettings.blade.php ENDPATH**/ ?>