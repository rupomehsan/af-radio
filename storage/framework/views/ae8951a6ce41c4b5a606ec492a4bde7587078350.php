            ...
            <div class="row justify-content-between align-items-center border">
                ...
                <div class="col-4 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-md-4">
                            <a href="/admin/notification" class="font-weight-bold">Immediate Push</a>
                        </div>
                ...
                <?php $__currentLoopData = $target; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="table-actions text-center">
                            <button type="submit" class="resend-notification" data-id="<?php echo e($data->id); ?>"
                                    title="Delete">
                                <iconify-icon icon="bi:send-x-fill"></iconify-icon>
                                Resend
                            </button>
                            <button type="submit" class=""
                                    onclick="deleteItem('notification/<?php echo e($data->id); ?>')"
                                    title="Delete">
    ...
    <script type="text/javascript">
        ...
        function getSearchData(data) {
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {"value": data, "type": "immediate"},
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/af_radio/resources/views/notification/index.blade.php ENDPATH**/ ?>