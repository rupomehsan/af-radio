                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-3 col-4">
                        <select class="form-select" name="country_id" id="country_id">
                            ...
                            <option value="<?php echo e($countr->id); ?>"><?php echo e($countr->name); ?></option>
    ...
    <div class="row" id="filterData">
        <?php if(!$target->isEmpty()): ?>
            ...
            <div class="col-md-4 single-content margin-top-40">
                <a href="radio/schedule/<?php echo e($data->id); ?>">
                    <div class="single-content-wraper margin-top-20">
                        <div class="language"><?php echo e($data->language->name??""); ?></div>
                        <?php if(!empty($data->image)): ?>
                        <img src="<?php echo e($data->image); ?>" alt="<?php echo e($data->name); ?>" title="<?php echo e($data->name); ?>" />
                        <?php else: ?>
                        ...
                        <div class="total-videos margin-top-20">
                            ...
                            <p class="cat-title"><?php echo e(Str::limit($data->radio_name, 20)); ?></p>
                            <div class="switch">
                                <label class="">
                    ...
                    <div class="content-actions m-2">
                            <a href="<?php echo e(url('admin/radio/edit', $data->id)); ?>" class="button">
                                <span class="iconify" data-icon="ant-design:edit-filled"></span>
                                Edit
                            </a>
                            
                            <button data-id="<?php echo e($data->id); ?>" class="deleteBtn"  type="submit" title="Delete" id="news">
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/af_radio/resources/views/radio/index.blade.php ENDPATH**/ ?>