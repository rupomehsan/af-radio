                                   ...
                                   <tr>
                                        ...
                                        <td>
                                            <div class="table-btn d-flex align-items-center justify-content-center" style="margin-top: -10px;">
                                                        <a href="<?php echo e(url('admin/contest/participant-list')); ?>/${item.id}" class="d-flex btn-sm align-items-center justify-content-center text-decoration-none btn tn-light border">
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/af_radio/resources/views/contest/question.blade.php ENDPATH**/ ?>